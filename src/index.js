...
function extendWithComponent (api, conf) {
  ...
  if (!boot.includes('quasar-app-extension-swipe-to-close/src/components/boot/index.js')) {
    boot.push('quasar-app-extension-swipe-to-close/src/components/boot/index.js')
